...
@interface Entity : OFObject {
    @private OFMutableDictionary<Class, OFMutableArray<id<IComponent>> *> *_components;
}

@property(readonly) OFString *identifier;
@property(readonly) OFMutableArray<OFString *> *tags;
